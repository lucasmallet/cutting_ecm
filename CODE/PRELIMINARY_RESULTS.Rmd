...
## 3.2.1 alpha
```{r rarecurve}
hala_rrcurve_groups0 <- phyloseq.extended::ggrare(hala_grp, step = 10, color = "specification", label="sample_id",plot=F, se=T)+ 
  facet_wrap(~year)
hala_rrcurve_groups0

hala_rrcurve_groups1 <- phyloseq.extended::ggrare(hala_grp_12, step = 10, color = "specification", label="sample_id",plot=F, se=T)+ 
  facet_wrap(~year)
hala_rrcurve_groups1

hala_rrcurve_groups2 <- phyloseq.extended::ggrare(hala_grp_18, step = 10, color = "specification", label="sample_id",plot=F, se=T)+ 
  facet_wrap(~year)
...
```{r rarecurve}
hala5_rrcurve0 <- phyloseq.extended::ggrare(hala5_grp, step = 10, color = "treatment", label="sample_id",plot=F, se=T) 
hala5_rrcurve0
###
...
```{r rarecurve}
fanga_rrcurve0 <- phyloseq.extended::ggrare(fanga_grp_12, step = 10, color = "treatment", label="sample_id",plot=F, se=T)+ facet_wrap(~year) 
fanga_rrcurve0

fanga_rrcurve1 <- phyloseq.extended::ggrare(fanga_grp_18, step = 10, color = "treatment", label="sample_id",plot=F, se=T)+ facet_wrap(~year)
fanga_rrcurve1
###
