...
# by sample
heatmap <- plot_heatmap(ecm_phy, method = "MDS", distance = "bray",
             sample.label = "treatment_edge",
             taxa.label = "Genus")
heatmap
...
htmp_all # is it possible to represent it by taxa Genus ? 

View(htmp_all$data)


# transforming Genus in factor 
htmp_all_df <- data.frame(htmp_all$data)
...
treat <- ifelse(grepl("CC_EDG", ht_count$yr_treat), "CC_EDG",
                         ifelse(grepl("CC_MID", ht_count$yr_treat), "CC_MID", "FOR")) # nested ifelse
