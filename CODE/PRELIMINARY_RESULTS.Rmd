...
colnames(hala_sam)
summary(hala_sam[,c(2,5:8)])
table(ecm_phy@sam_data$plot, ecm_phy@sam_data$treatment)
...
length(ecm_phy@sam_data$sample_id) # N= 7 missing after bioinformatic analysis 
# result: 3 (n=3); 8 (n=1) 

table(phy_12@sam_data$plot, phy_12@sam_data$treatment)
table(phy_18@sam_data$plot, phy_18@sam_data$treatment)

summary(ecm_phy@sam_data$treatment_edge)
summary(as.factor(phy@sam_data$treatment_edge))
