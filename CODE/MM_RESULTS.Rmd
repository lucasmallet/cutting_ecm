...
```{r }
# tax-eco table
setwd("C:/Users/Utilisateur/OneDrive/STAGE-2023_SUEDE/cutting_ecm/TRANSF_DATA")
...
# clust all
setwd("C:/Users/Utilisateur/OneDrive/STAGE-2023_SUEDE/cutting_ecm/RAW_DATA")
raw_clust <- read.table("raw_clusters.txt",header=T,sep="\t",na.strings=T,dec=".") %>% arrange(desc(Cluster_Size))
