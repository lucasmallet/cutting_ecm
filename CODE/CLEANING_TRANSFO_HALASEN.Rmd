...
otu_not_in_hala <- which(colSums(otu_fungi_hala) == 0) # 1182 clusters
otu_fungi_hala <- otu_fungi_hala[, -otu_not_in_hala]
ncol(otu_fungi_hala)
nrow(otu_fungi_hala)
...
otu_not_in_hala5p <- which(colSums(otu_fungi_hala5p) == 0) # 1182 clusters
otu_fungi_hala5p <- otu_fungi_hala5p[, -otu_fungi_hala5p]
ncol(otu_fungi_hala5p)
...
otu_not_in_fanga <- which(colSums(otu_fungi_fanga) == 0) # 1182 clusters
otu_fungi_fanga <- otu_fungi_fanga[, -otu_fungi_fanga]
ncol(otu_fungi_fanga)
...
otu_001_1 <- subset(otu_001_transf1, !rowSums(otu_001_transf1) == 0) # deleting clusters with 0 

otu_relative2 <- prop.table(otu2, margin = 2) 
otu_001_transf2 <- ifelse(otu_relative2 > 0.01, otu2, 0) 
otu_001_2 <- subset(otu_001_transf2, !rowSums(otu_001_transf2) == 0) 

otu_relative3 <- prop.table(otu3, margin = 2) 
otu_001_transf3 <- ifelse(otu_relative3 > 0.01, otu3, 0) 
otu_001_3 <- subset(otu_001_transf3, !rowSums(otu_001_transf3) == 0)
```
...
ecm_abun_df <- data.frame(phy_relat2@sam_data$sample_id, phy_relat2@sam_data$plot, phy_relat2@sam_data$year, phy_relat2@sam_data$treatment_code, ecm_abun)
colnames(ecm_abun_df) <- c("sample_id", "plot", "year", "treatment_code", "ecm_abun")
